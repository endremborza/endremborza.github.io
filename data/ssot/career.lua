return {
  work = {
    ...
    },
    {
      ...
      org = "ANET-lab - Centre for Economic and Regional Studies",
      description = "Scientific data engineering and interpretable machine learning projects",
    },
    {
      start = 2018,
      finish = 2021,
  ...
  education = {
    {
      ...
      thesis = "Scalable Local Market Analysis of Hotels",
    },
    {
      start = 2012,
      finish = 2018,
  ...
  awards = {
    {
      year = 2025,
      name = "Webby Nomination",
      org = "The International Academy of Digital Arts and Sciences",
      description = "For Rankless in Science Websites and Mobile Sites",
    },
    {
      year = 2022,
    ...
    {
      year = 2018,
      name = "Heller Farkas Award",
      org = "Rajk College",
      description = "Outstanding academic achievement in graduating class",
    },
  },
}
